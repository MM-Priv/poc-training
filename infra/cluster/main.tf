...
module "filestore" {
  source = "../../../nebius-solutions-library/soperator/modules/filestore"
...
module "nfs-server" {
  ...
  source = "../../../nebius-solutions-library/modules/nfs-server"
...
module "cleanup" {
  source = "../../../nebius-solutions-library/soperator/modules/cleanup"

  iam_project_id = var.iam_project_id
}

module "k8s_cleanup" {
  source = "../../../nebius-solutions-library/soperator/modules/k8s_cleanup"
...
module "k8s" {
  ...
  source = "../../../nebius-solutions-library/soperator/modules/k8s"
...
module "nvidia_operator_network" {
  ...
  source = "../../../nebius-solutions-library/modules/network-operator"
...
module "nvidia_operator_gpu" {
  ...
  source = "../../../nebius-solutions-library/modules/gpu-operator"
...
module "o11y" {
  ...
  source = "../../../nebius-solutions-library/soperator/modules/o11y"
...
module "slurm" {
  ...
  source = "../../../nebius-solutions-library/soperator/modules/slurm"
...
module "login_script" {
  ...
  source = "../../../nebius-solutions-library/soperator/modules/login"
...
module "backups_store" {
  ...
  source = "../../../nebius-solutions-library/soperator/modules/backups_store"
...
module "backups" {
  ...
  source = "../../../nebius-solutions-library/soperator/modules/backups"
...
module "fluxcd" {
  ...
  source              = "../../../nebius-solutions-library/soperator/modules/fluxcd"
  k8s_cluster_context = module.k8s.cluster_context
}
